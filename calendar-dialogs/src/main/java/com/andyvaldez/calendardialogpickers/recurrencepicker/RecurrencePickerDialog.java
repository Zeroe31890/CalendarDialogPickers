...
package com.andyvaldez.calendardialogpickers.recurrencepicker;
...
import com.andyvaldez.calendardialogpickers.datetimepicker.date.DatePickerDialog;
...
public class RecurrencePickerDialog extends DialogFragment implements OnItemSelectedListener,
    ...
    public void onClick(View v) {
        if (mEndDateTextView == v) {
            ...
            mDatePickerDialog.show(getActivity().getFragmentManager(), FRAG_TAG_DATE_PICKER);
        } else if (mDone == v) {
            String rrule;
            if (mModel.recurrenceState == RecurrenceModel.STATE_NO_RECURRENCE) {
                rrule = null;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mDatePickerDialog = (DatePickerDialog) getActivity().getFragmentManager()
